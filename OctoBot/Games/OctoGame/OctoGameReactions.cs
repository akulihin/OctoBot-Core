            ...
            for (var i = 0; i < Global.OctopusGameMessIdList.Count; i++)
            {
                ...
                switch (reaction.Emote.Name)
                {
                    case "🐙":
                        ...
                        await Global.OctopusGameMessIdList[i].SocketMsg.RemoveReactionAsync(reaction.Emote,
                            Global.OctopusGameMessIdList[i].Iuser, RequestOptions.Default);
                        break;
                    case "⬅":
                    ...
                    case "📖":
                        ...
                        break;
                    case "❌":
                        await OctoGameUpdateMess.FighhtReaction.EndGame(reaction,
                            Global.OctopusGameMessIdList[i].SocketMsg);
                        break;
                    case "1⃣":
                    {
                        ...
                        if (account.OctopusFightPlayingStatus == 2)
                        {
                            ...
                            switch (account.MoveListPage)
                            {
                                case 1:
                                {
                                    ...
                                    {
                                        dmg = GameSpellHandeling.CritHandeling(account.CurrentOctopusFighterAgility,
                                            dmg, account);
                                    }
                                    else
                                    {
                                    ...
                                    dmg = GameSpellHandeling.DodgeHandeling(account.CurrentOctopusFighterAgility, dmg,
                                        account);
