   ...
   public class UpdateShadowMess : ModuleBase<SocketCommandContextCustom>
    {
        ...
        public async Task Boolek()
        {
         ...
         // var nintendoswitch = Emote.Parse("<:nintendoswitch:447209827501080596>");
            ...
            embed.AddField("Роль для рум", "Чтобы **получить** или **снять** роль просто нажмите определенную эмоцию, или пропишите соответствующую команду в <#374914059679694848>\n" +
                                                 "**________**\n");
            embed.AddField("Блокирующие каналы роли:", $"!блок - всю категорию **stream**, больше никаких бесполезных оповещений не будет {new Emoji("<:RKN:445325930022436874>")}\n" +
            ...
            embed.AddField($"Игровые Комнаты:", $"!hots - <#421637740137021450> и <#425354467022602258> Нет времени объяснять ─ фокуси танка {new Emoji("<:hanzo:445324859690582018>")}\n" +
            ...
            {/*
                ...
                */
                ...
                embed.AddField($"Игровые Комнаты:",
                    ...
                    $"**________**\n");
                    embed.AddField("Нове румы:",  $"{new Emoji("<:warframe:445467639242948618>")} - !warframe - симулятор фермера в космосе\n" +
